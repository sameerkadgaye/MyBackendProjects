 ...
 *
 */
public class BubbleSortWithStringSimpleExample {

	// Simple Logic Not Enhancement Program.
	public static void main(String[] args) {
		//int unOrderList[] = { 36, 19, 29, 12, 5 };
		String unOrderList[] = { "Zaher", "Aman", "Balu", "Talu", "Shalu" , "Chetan"};
		String tempHoldValue;
		for (int round = 0; round < unOrderList.length; round++) { // compareArrayIndex Val
			for (int compValueOfIndex = 0; compValueOfIndex < unOrderList.length - 1; compValueOfIndex++) {
				...
				if (unOrderList[compValueOfIndex].compareTo(unOrderList[compValueOfIndex + 1]) > 0) {
